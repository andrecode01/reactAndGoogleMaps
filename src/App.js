...
export default function App() {
  return (
    <div style={{margin: '0 auto', width:'80vw', height:'100vh'}}>
      ...
      <WrappedMap 
        googleMapURL={'https://maps.googleapis.com/maps/api/js?key=AIzaSyCqbsMLA-NxlHO5mz4JoLjwO9QFw2PTQ5U&v=3.exp&libraries=geometry,drawing,places&callback=initMap'}
